...
(function ($) {
  ...
  $(window).on("load", function () {}); // end of window load function
  ...
  $(document).ready(function () {
    ...
    $(testimonial).owlCarousel({
      ...
      responsive: {
        0: {
          // breakpoint from 0 up - small smartphones
          items: 1,
        },
        992: {
    ...
    $(window).scroll(function () {
      $(this).scrollTop() > offset
        ...
        : back_to_top.removeClass("back-top-visible");
    });
    ...
    window.initialize = function () {
      ...
      var markers = [["Cariera", 40.710439, -74.005072]];
    ...
    tinymce.init({
      ...
      menubar: false,
      toolbar:
        "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist", // change this value according to your HTML
    });
