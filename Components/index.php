            ...
            <div class="row nomargin">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 cat-wrapper">
                    <div class="category ptb30">
                        ...
                        <div class="category-info pt30">
                            <a href="./All_Doctor.php">Dermatologist</a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 cat-wrapper">
                    <div class="category ptb30">
                        ...
                        <!-- Category Info - Title -->
                        <div class="category-info pt30">
                            <a href="./All_Doctor.php">Urologist</a>
                            <!-- <p>(9 open positions)</p> -->
                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 cat-wrapper">
                    <div class="category ptb30">
                        ...
                        <!-- Category Info - Title -->
                        <div class="category-info pt30">
                            <a href="./All_Doctor.php">Gastroenterologist</a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 cat-wrapper">
                    <div class="category ptb30">
                        ...
                        <!-- Category Info - Title -->
                        <div class="category-info pt30">
                            <a href="./All_Doctor.php">Child Specialist</a>
            ...
            <div class="row pt40 nomargin">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 cat-wrapper">
                    <div class="category ptb30">
                        ...
                        <!-- Category Info - Title -->
                        <div class="category-info pt30">
                            <a href="./All_Doctor.php">Gynecologist</a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 cat-wrapper">
                    <div class="category ptb30">
                        ...
                        <div class="category-info pt30">
                            <a href="./All_Doctor.php">Migraine</a>
                        </div>
                        <div class="category-descr">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 cat-wrapper">
                    <div class="category ptb30">
                        ...
                        <div class="category-info pt30">
                            <a href="./All_Doctor.php">Psychiatrist</a>
                        </div>
                        <div class="category-descr">
